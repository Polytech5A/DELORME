...
public class Oeuvre {
    ...
    public void insertionOeuvre(Oeuvre uneOeuvre) throws MonException {
        ...
        try {
            ...
            mysql = mysql + " VALUES ( \'" + uneOeuvre.getTitre() + "\', \'" + uneOeuvre.getEtat() + "\', " + uneOeuvre.getPrix() + ", " + uneOeuvre.getidproprietaire() + ")";
    ...
    public void modificationOeuvre(Oeuvre uneOeuvre) throws MonException {
        ...
        try {
            ...
            mysql = mysql + "SET titre_oeuvrevente = \'" + uneOeuvre.getTitre() + "\' , etat_oeuvrevente = \'" + uneOeuvre.getEtat() + "\', " + "prix_oeuvrevente = " + uneOeuvre.getPrix() + ", id_proprietaire = " + uneOeuvre.getidproprietaire();
